...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_directory' ); ?>/stylemobileTablet.css" />
	...
	<body>
		<div id="wrap" ><div id="main" class="clearfix"><div id="topBackRepeat">
			<div id="header"><div class='container'>
				<a href='<?=site_url()?>/' class='logo'><img src='<?= get_bloginfo('template_url')?>/tablet_imgs/logo.png' alt='#yocontribuyente logo' /></a>
				<h3 class='hastag'><img alt='yocontribuyente' src='<?= get_bloginfo('template_url')?>/tablet_imgs/twittera.png' /><strong>YO</strong>CONTRIBUYENTE</h3>
				<div class='clear'></div>
			...
			<div class='content'>
				...
				<div class='cap'>
					<img alt='yocontribuyente' src='<?= get_bloginfo('template_url')?>/tablet_imgs/flechita.png' />
				</div>
				...
				<div class='form'>
					...
					<div class='float-right'>
						<h3>¡Gracias a tí! </br>
							<img alt='yocontribuyente' src='<?= get_bloginfo('template_url')?>/tablet_imgs/dividinga.png' />
						</h3>
					</div>
					<div class='clear'></div>
				</div>
		...
		<div id="footer">
			<ul>
				<li class='amparo'>
					<a>
						<img alt='amparo' src='<?= get_bloginfo('template_url')?>/tablet_imgs/icono1.png' />
						<strong>Amparo</strong> #YOCONTRIBUYENTE 
						<span>Leer más</span>
						<span class='clear'></span>
					</a>
				...
				<li class='amparo'>
					<a>
						<img alt='yocontribuyente' src='<?= get_bloginfo('template_url')?>/tablet_imgs/icono2.png' />
						Aviso de privacidad 
						<span>Leer más</span>
						<span class='clear'></span>
					</a>
				...
				<li>
					<a href='https://twitter.com/search?q=yocontribuyente&src=typd'>
						<img alt='@yocontribuyente' src='<?= get_bloginfo('template_url')?>/tablet_imgs/icono3.png' />
						<strong>#YO</strong>CONTRIBUYENTE
